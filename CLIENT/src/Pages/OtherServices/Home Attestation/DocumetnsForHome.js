...
function DocumetnsForHome() {
  return (
    <>
        <div className='bg-zinc-100 h-full w-full my-12'>
            <div className='flex  max-w-[1240px] mx-auto place-content-center '>
                <div className='grid lg:grid-cols-2 py-10 '>
                    ...
                    <h1 className='text-4xl py-4 md:text-5xl font-HeadingFont font-bold text-green-500'> <b className='text-black'> Documents Required For </b> Home Department Attestation</h1>
