    ...
    <>
        <div className='max-w-[1240px] mx-auto place-content-center py-10'>
          <div className='flex mx-4 lg:px-16 px-3'>
            ...
            <h3 className='md:text-5xl lg:px-48 text-3xl pb-5 font-HeadingFont font-extrabold text-black  tracking-wide  '> Process in Dataflow for<br/><b className='text-green-500'> Saudi Medical Professionals </b></h3>
          </div>
        <div className='flex'>
...
export default ProcessForSaudi