            ...
            <div className=' max-w-[1240px] mx-auto place-content-center my-10'>
                ...
                <div className='flex flex-col justify-center my-10'>
                    <div>
                        ...
                        The procedure for educational document attestation is as follows: The candidate has to do HRD attestation first, followed by <a href='/mea-attestation' className='font-semibold'> MEA attestation</a>  and Embassy attestation.
                        </p>
