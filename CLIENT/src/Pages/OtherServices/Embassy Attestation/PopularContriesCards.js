      ...
      <div className='hidden md:flex flex-col justify-center items-center my-10'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={uae_img} alt="uae_banner" />
            <h3 className='flex absolute text-2xl lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-10  pl-5 pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500  mr-2"/></span>  UAE Embassy Attestation </h3>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={qatar_img} alt="qatar_banner" />
            <h3 className='flex absolute text-2xl lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-[45%] pl-[40%] pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mr-2"/></span>  Qatar Embassy Attestation </h3>
