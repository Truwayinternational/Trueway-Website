    ...
    <div className='h-[80px] w-screen bg-green-600 drop-shadow-lg hidden  lg:flex items-center'>
        <div className='ms-44 flex justify-between items-center w-full h-full'>
          <div className='hidden lg:flex items-center text-zinc-100 text-md'>
            <span className='flex p-3'> <BsWhatsapp  className='mt-1'/><a href="https://wa.link/c3ukjh" className='px-2'> +91 83276 26262 </a></span>
            <span className='flex p-3'> <BsFillTelephoneFill  className='mt-1'/><a href="tel:+918327626262" className='px-2'> +91 83276 26262 </a></span>
            <span className='flex p-3'> <TfiEmail  className='mt-1'/><a href="mailto:tvm@truewayinternational.com" className='px-2'> Email Us </a></span>
          </div>
