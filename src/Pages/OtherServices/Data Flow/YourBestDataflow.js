        ...
        <div className='flex justify-center items-center bg-zinc-100 h-full w-full'>
            <div className='grid md:grid-cols-2 max-w-[1240px] py-10 '>
                ...
                <div className='flex flex-col lg:pr-20 md:pr-10 pr-4 md:px-0  px-5'>
                    <h5 className='text-4xl py-4 md:text-5xl font-HeadingFont font-bold '> <b className='text-green-500'> Trueway:</b> Your Best DataFlow Choice for Gulf Countries</h5>
