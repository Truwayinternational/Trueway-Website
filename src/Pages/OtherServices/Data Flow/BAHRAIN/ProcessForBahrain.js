    ...
    <>
        <div className='max-w-[1240px] mx-auto place-content-center py-10'>
          <div className='flex mx-4 lg:px-16 px-3'>
            ...
            <h3 className='md:text-5xl lg:pl-48 text-3xl pb-5 font-HeadingFont font-extrabold text-black  tracking-wide  '>Dataflow Process for<br/><b className='text-green-500'> Bahrain Medical Professionals </b></h3>
          </div>
        <div className='flex'>
          ...
          <div className='w-full lg:px-12 lg:pr-16 px-4 pl-6 '>
            ...
            You must follow certain steps in order to immigrate to Bahrain; else, your certificate won't be accepted. Only you can show up for future procedures until the authority verifies and shows that your certifications are legitimate and real. The Bahrain Dataflow's primary processes are listed below.
            </p>
...
export default ProcessForBahrain