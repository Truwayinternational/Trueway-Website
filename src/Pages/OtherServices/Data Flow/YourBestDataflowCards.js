       ...
       <div className='bg-zinc-200 h-full w-full'>
            <div className='flex  max-w-[1240px] mx-auto place-content-center '>
                <div className='grid grid-cols-1 pb-10 mx-5'>
                    ...
                    >
                        <SwiperSlide>
                            <div className="flex  h-[30rem] py-10 flex-col justify-center px-auto m-4 p-3  bg-white px-4 rounded-3xl hover:shadow-lg hover:bg-green-50 cursor-pointer">
