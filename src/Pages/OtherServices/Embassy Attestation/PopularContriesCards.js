      ...
      <div className='hidden md:flex flex-col justify-center items-center my-10'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={uae_img} alt="uae_banner" />
            <h3 className='flex absolute text-2xl lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-10  pl-5 pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span>  UAE Embassy Attestation </h3>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={qatar_img} alt="qatar_banner" />
            <h3 className='flex absolute text-2xl lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-[45%] pl-[40%] pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span>  Qatar Embassy Attestation </h3>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={oman_img} alt="uae_banner" />
            <h3 className='flex absolute text-[23px] leading-8  lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-10  pl-5 pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-8px]"/></span>  Oman Embassy Attestation </h3>
            <p className='flex absolute lg:w-[500px] w-[350px] text-sm lg:text-lg font-poppins font-light text-gray-700 lg:pl-24 pl-10 pt-14 lg:pt-28'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={kuwait_img} alt="qatar_banner" />
            <h3 className='flex absolute text-[23px] leading-8 lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-[45%] pl-[40%] pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-8px]"/></span>  Kuwait Embassy Attestation </h3>
            <p className='flex absolute  text-sm lg:text-lg font-poppins font-light text-gray-700 lg:pl-[50%] pl-[45%] pr-14  pt-16 lg:pt-28'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={bahrain_img} alt="uae_banner" />
            <h3 className='flex absolute text-[22px] leading-8  lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-10  pl-5 pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-8px]"/></span>  Bahrain Embassy Attestation </h3>
            <p className='flex absolute lg:w-[500px] w-[350px] text-sm lg:text-lg font-poppins font-light text-gray-700 lg:pl-24 pl-10 pt-14 lg:pt-28'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={malaysia_img} alt="qatar_banner" />
            <h3 className='flex absolute text-[22px] leading-8 lg:text-4xl font-HeadingFont font-bold text-green-500 lg:pl-[43%] pl-[40%] pt-5 lg:pt-10 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-8px]"/></span>  Malaysia Embassy Attestation </h3>
