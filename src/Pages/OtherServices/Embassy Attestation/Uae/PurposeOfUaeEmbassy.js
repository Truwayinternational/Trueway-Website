    ...
    <>
        <div className='max-w-[1240px] mx-auto place-content-center py-10'>
            <div className='flex mx-4  lg:px-16 px-1'>
                <h2 className='md:text-5xl lg:px-6  lg:w-2/3 text-3xl pb-5  font-HeadingFont font-extrabold text-black  md:tracking-wide'> Purpose of<b className='text-green-500'> UAE Embassy Attestation </b></h2>
                ...
                <div className='lg:w-2/3 ml-3 lg:md-12 lg:px-24 px-3'>
                    <div className='text-md  md:text-lg text-start text-gray-500  pr-3 lg:p-0 lg:mr-0'>
                        <p className='font-poppins'>
                            The procedure of checking and validating your documents and stating the authenticity of the certificates is attestation. After checking the documents the relevant authorities put a signature or a stamp afterwards the applicant can make use of the documents. These are the need for UAE Embassy Attestation.
                        </p>
                    </div>
                </div>
...
export default PurposeOfUaeEmbassy