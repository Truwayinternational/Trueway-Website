...
function PurposeOfMalaysiaEmbassy() {
  return (
    <>
        <div className='max-w-[1240px] mx-auto place-content-center py-10'>
            <div className='flex mx-4  lg:px-16 px-1'>
                <h2 className='md:text-5xl lg:px-6  lg:w-2/3 text-3xl pb-5  font-HeadingFont font-extrabold text-black  md:tracking-wide'> Purpose of<b className='text-green-500'> Malaysian Embassy Attestation</b></h2>
                ...
                <div className='lg:w-2/3 ml-3 lg:md-12 lg:px-24 px-3'>
                    <div className='text-md  md:text-lg text-start text-gray-500  pr-3 lg:p-0 lg:mr-0'>
                        <p className='font-poppins'>
                            Validation of your certificates are so significant to migrate to Malaysia. The relevant authority will go through your documents and if they find all the submitted documents are legal and genuine then they approve them by stamping on it. With those attested certificates only you can migrate abroad. Without proper attestation migration is impossible.
                        </p>
                    </div>
                </div>
...
export default PurposeOfMalaysiaEmbassy