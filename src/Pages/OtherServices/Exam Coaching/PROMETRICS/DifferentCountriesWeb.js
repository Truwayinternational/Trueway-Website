    ...
    <>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={saudiPrometric} alt="saudiPrometricBanner" />
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 lg:pl-2  pt-3 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span>  Saudi Prometric Exam coaching in kerala </h4>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover' src={qatarPrometric} alt="qatar prometric" />
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 pl-[38%] pt-4 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span> Qatar Prometric Exam coaching in kerala </h4>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={omanPrometric} alt="OmanPrometric" />
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 lg:pl-2  pt-3 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span>  Oman Prometric Exam coaching in kerala </h4>
            <p className='flex absolute lg:w-[500px] w-[400px] text-sm lg:text-base font-poppins font-light text-gray-700 lg:pl-14 pl-10 pt-10 lg:pt-20'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover' src={KuwaitPrometric} alt="kuwait prometric" />
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 lg:pl-[37%] pl-[38%] pt-4 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span> Kuwait Prometric Exam coaching in Kerala </h4>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={bahrainPrometric} alt="bahrain prometric" />
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 pt-3 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span>Bahrain Prometric Exam coaching in Kerala </h4>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover' src={DHAprometric} alt="DHA prometric"/>
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 pl-[38%] pt-4 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span> DHA Prometric Exam coaching in Kerala </h4>
            <p className='flex absolute  text-sm lg:text-base font-poppins font-light text-gray-700  pl-[43%] pr-14  pt-10 lg:pt-20'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover ' src={MohPrometric} alt="MOH prometric" />
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 lg:pl-2  pt-3 lg:pt-8'><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span>  MOH Prometric Exam Coaching in Kerala </h4>
            <p className='flex absolute lg:w-[500px] w-[400px] text-sm lg:text-base font-poppins font-light text-gray-700 lg:pl-14 pl-10 pt-10 lg:pt-20'>
        ...
        <div className='flex m-3 md:relative px-8 my-5'>
          <img className='object-cover' src={HaadPrometric} alt="HAAD prometric"/>
            <h4 className='flex absolute lg:text-2xl text-base font-HeadingFont font-bold text-green-500 pl-[38%] pt-4 lg:pt-8 '><span> <BiSolidChevronRightCircle className="text-green-500 mt-[-10px]"/></span> HAAD Prometric Exam Coaching in Kerala </h4>
            <p className='flex absolute  text-sm lg:text-base font-poppins font-light text-gray-700  pl-[43%] pr-14  pt-10 lg:pt-20'>
