        ...
        <div className='max-w-4xl mx-auto place-content-center py-10'>
            <div className='flex mx-4 lg:px-16 md:px-3 px-1'>
                ...
                <div className='md:flex md:flex-col md:pl-3'>
                    ...
                    Trueway mostly gives good standing certifications for two nations: GCC countries and European countries. The nations for which we supply good standing certificates are listed below.
                    </p>
                </div>
            </div>
        </div>
...
export default WeProvideKarnataka