    ...
    <>
        <div className='max-w-[1240px] mx-auto place-content-center mt-10 '>
            <div className='flex mx-4  lg:px-16 px-3'>
                <h2 className='md:text-5xl text-3xl pb-5 font-HeadingFont font-extrabold text-black text-center md:text-start  tracking-normal '> Significance of having <br/><b className='text-green-500'> Good standing and <br/> Verification </b> from council</h2>
            </div>
            <div className='lg:w-full ml-3 lg:pl-[70px] px-4 '>
                <p className='text-md md:text-xl lg:text-lg text-gray-500 font-poppins text-center md:text-start pr-3 lg:p-0  max-w-4xl'>
