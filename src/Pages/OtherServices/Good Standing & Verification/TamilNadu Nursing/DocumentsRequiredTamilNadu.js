                        ...
                        <div className='max-w-2xl my-4 font-HeadingFont'>
                            ...
                            <ul className='md:text-xl  py-3 text-lg  text-green-500 w-fit font-HeadingFont font-bold cursor-pointer'>
                                <div className='bg-transparent md:rounded-2xl md:hover:bg-white w-fit p-2 my-1 cursor-pointer'>
                                    ...
                                    <li className='ml-2 md:ml-4 mt-[-40px]  mb-[-20px]'> Tamil Nadu Registration certificate copy<span className='font-normal'>(Both Nurse & Midwife)</span>
                                    </li>
                                </div>
                                ...
                                <div className='bg-transparent md:rounded-2xl md:hover:bg-white w-fit p-2 my-1 cursor-pointer'>
                                    <BiSolidChevronRightCircle />
                                    <li className='ml-2 md:ml-4 mt-[-40px]  mb-[-20px]'> Experience Certificate <span className='font-normal'>(In Tamil Nadu)</span>
                                    </li>
                                </div>
