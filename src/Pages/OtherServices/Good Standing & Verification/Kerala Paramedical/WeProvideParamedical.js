        ...
        <div className='flex mx-4 lg:px-16 md:px-3 px-1'>
            ...
            <div className='md:flex md:flex-col md:pl-3'>
                ...
                <p className='text-md md:text-xl lg:text-lg text-gray-500 font-poppins pr-3 lg:p-0'>
                    Trueway mostly issues good standing certifications to two groups of countries: GCC countries and European countries. The countries for which we provide good standing certificates are mentioned below.
                </p>
            </div>
        </div>
    </div>
...
export default WeProvideParamedical