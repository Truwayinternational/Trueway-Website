...
function WeProvideDelhi() {
  return (
    <>
        <div className='max-w-4xl mx-auto place-content-center py-10'>
            <div className='flex mx-4 lg:px-16 md:px-3 px-1'>
                <img className='hidden md:flex h-full lg:ml-6 py-4 md:-mt-16 lg:-mt-5 md:w-[26%] lg:w-[22%]'  src={Avatar_4} alt="avatar4"/>
                <div className='md:flex md:flex-col md:pl-3'>
                    ...
                    Trueway primarily provides Good Standing Certificates for two regions: GCC (Gulf Cooperation Council) and European countries. Here is a list of the countries where we can deliver Good Standing Certificates.
                    </p>
                </div>
            </div>
        </div>
