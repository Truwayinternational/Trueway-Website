        ...
        <div className='max-w-6xl mx-auto place-content-center py-10'>
            <div className='flex flex-col mx-4 lg:px-16 md:px-3 px-1'>
                <div className='grid lg:grid-cols-2 '>
                    <div className='grid '>
                        <h2 className='text-3xl px-4 text-center lg:text-start  md:text-5xl font-HeadingFont font-bold tracking-wide'>
                ...
                {/* content added here */}
                <div className='flex'>
                <p className='text-md md:text-xl lg:text-lg lg:text-start text-center  text-gray-500 font-poppins mt-5 lg:p-0'>
