  ...
  return (
    <div>
         <div className='w-full h-full flex flex-col justify-between bg-zinc-200'>
            <div className="grid max-w-[1240px] mt-10 mx-auto px-5">
                <div className='flex flex-col justify-center lg:items-center w-full py-4'>
                    <h2 className=' text-4xl md:text-5xl tracking-wide font-bold text-center font-HeadingFont px-2'> We are here to<span className='text-green-500'>help you!</span></h2>
                    <p className='font-poppins mt-5 text-center lg:px-10 md:px-20 font-extralight text-gray-800'>
                    ...
                    <br />
                    <img className='md:hidden py-3 ' src={Helpyou_mob} alt="helpyou_content" />
                </div>
            </div>
        </div>
    </div>
