  ...
  return (
    <div>
         <div className='w-full h-full flex flex-col justify-between bg-zinc-200'>
            <div className="grid max-w-[1240px] mt-10 m-auto px-5">
                <div className='flex flex-col justify-center lg:items-center w-full px-2 py-4'>
                    <h2 className=' text-4xl md:text-5xl tracking-wide font-bold text-center font-HeadingFont'> We are here to<span className='text-green-500'>help you!</span></h2>
