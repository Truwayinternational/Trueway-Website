    ...
    <div>
        <div className='h-full w-max-1240px py-10'>
            <div className='flex mx-4 lg:px-16 px-3'>
              <h3 className='md:text-5xl text-3xl pb-5  font-Philosopher font-extrabold text-black  tracking-wide  '>What is<br/><p className='text-green-500'>Attestation ?</p></h3>
