    ...
    <div className='lg:hidden h-full w-full '>
      ...
      >
        ...
        <div className="image relative">
          ...
          <div className=" absolute top-[5px] pl-5 ">
        ...
        <div className="image relative">
          ...
          <div className=" absolute top-[5px] pl-5 ">
            <h3 className='text-[30px] md:text-[48px] font-semibold leading-10 md:leading-normal py-2 md:px-5 font-HeadingFont'> Make The Migration<br /><b className='md:text-[60px] tracking-normal'>Smooth With Dataflow</b></h3>
            <p className='font-poppins md:text-[30px]  text-[14px] w-[100%] md:px-8 justify-center text-gray-600 '>
        ...
        <div className="image relative">
          ...
          <div className=" absolute top-[5px] pl-5 ">
            <h3 className='text-[30px] md:text-[54px] font-bold leading-10 md:leading-normal md:px-5 font-HeadingFont'>The Complete Option for Exam Coaching</h3>
            <p className='font-poppins md:text-[32px]  text-[14px] w-[100%] md:px-8 justify-center text-gray-600 py-1'>
        ...
        <div className="image relative">
          ...
          <div className=" absolute top-[10px] px-5 font-[poppins]">
            <h3 className='text-[30px] md:text-[54px] font-bold leading-10 md:leading-normal py-3 md:px-5 font-HeadingFont'> Is Employment Abroad your dream? </h3>
            ...
            <button className='flex rounded-lg p-2 my-2 px-4  bg-transparent border-solid border-2 border-green-600 md:text-3xl md:p-3 md:m-5 md:my-5'>
             <BiSolidPhoneCall className='text-green-700 text-xl mx-2  md:text-3xl '/> <a href="tel:+918327626262">Free Consulting Now</a>
            </button>
          </div>
        </div>
        </SwiperSlide>
