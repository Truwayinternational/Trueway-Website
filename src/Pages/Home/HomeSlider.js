    ...
    <div className='lg:flex hidden'>
      ...
      <SwiperSlide>
        <div className="image relative">
          ...
          <div className="title_content absolute top-[10%] left-[6rem]">
            ...
            <button className='flex rounded-lg p-2 px-4  bg-transparent border-solid border-2 border-green-600 my-5'>
      ...
      <div className="image relative">
          <img src={slider4} alt="" />
          <div className="title_content absolute top-[10%] left-[6rem] space-y-5">
