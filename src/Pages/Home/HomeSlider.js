  ...
  return (
    ...
    <div className='md:flex hidden '>
      ...
      <SwiperSlide>
        <div className="relative ">
          ...
          <div className="absolute top-[5%] left-5 lg:top-[10%] lg:left-[6rem]">
            <h6 className='text-[30px] 2xl:text-[3rem] font-HeadingFont'> Hello From <br/>
             <b className='text-[40px] 2xl:text-[3.5rem]'> Trueway International </b></h6>
            <p className='font-poppins text-[14px] 2xl:text-[1.2rem] w-[40%] justify-center text-gray-600'>
            ...
            <button className='flex rounded-lg p-2 px-4 2xl:p-3 2xl:px-6 bg-transparent border-solid border-2 border-green-600 my-5 2xl:my-8 2xl:text-2xl'>
             <IoLogoWhatsapp className='text-green-700 text-2xl mx-2 2xl:mx-4 2xl:text-3xl'/> <a href="https://wa.link/c3ukjh">Free Consulting Now</a>
            </button>
          </div>
        </div>
      </SwiperSlide>
      ...
      <div className=" relative">
          ...
          <div className=" absolute top-[5%] left-5 lg:top-[10%] lg:left-[6rem]">
            <h6 className='text-[30px] 2xl:text-[3rem] font-HeadingFont'> Make The Migration <br />
            <b className='text-[40px] 2xl:text-[3.5rem]'>Smooth With Dataflow</b></h6>
            <p className='font-poppins text-[14px] 2xl:text-[1.2rem] w-[40%] justify-center text-gray-600'>
            ...
            <button className='flex rounded-lg p-2 px-4 2xl:p-3 2xl:px-6 bg-transparent border-solid border-2 border-green-600 my-5 2xl:my-8 2xl:text-2xl'>
             <IoLogoWhatsapp className='text-green-700 text-2xl mx-2 2xl:mx-4 2xl:text-3xl'/> 
      ...
      <div className=" relative">
          ...
          <div className=" absolute top-[5%] left-5 lg:top-[10%] lg:left-[6rem]">
            <h6 className='text-[30px] 2xl:text-[3rem] font-HeadingFont'> The Complete Option for <br/><b className='text-[40px] 2xl:text-[3.5rem]'>Exam Coaching</b></h6>
            <p className='font-poppins text-[14px] 2xl:text-[1.2rem] w-[40%] justify-center text-gray-600'>
            ...
            <button className='flex rounded-lg p-2 px-4 2xl:p-3 2xl:px-6 bg-transparent border-solid border-2 border-green-600 my-5 2xl:my-8 2xl:text-2xl'>
             <IoLogoWhatsapp className='text-green-700 text-2xl mx-2 2xl:mx-4 2xl:text-3xl '/> <a href="https://wa.link/c3ukjh">Register your slot now</a>
            </button>
          </div>
        </div>
      </SwiperSlide>
      ...
      <div className=" relative">
          ...
          <div className=" absolute top-[5%] left-5 lg:top-[10%] lg:left-[6rem] space-y-5">
            <h6 className='text-[30px] 2xl:text-[3rem] font-HeadingFont'><b>Is Employment Abroad your dream?</b></h6>
            <p className='font-poppins text-[14px] 2xl:text-[1.2rem] w-[40%] justify-center text-gray-600'>
            ...
            <button className='flex rounded-lg p-2 px-4 2xl:p-3 2xl:px-6 bg-transparent border-solid border-2 border-green-600 my-5 2xl:my-8 2xl:text-2xl' >
             <BiSolidPhoneCall className='text-green-700 text-2xl mx-2 2xl:mx-4 2xl:text-3xl'/> <a href="tel:+918327626262">Free Consulting Now</a>
            </button>
          </div>
        </div>
      </SwiperSlide>
        <div className="top-[60%] absolute z-10 button-prev-slide h-[40px] w-[40px]  text-white bg-black grid place-items-center group-hover:left-0  -left-[23rem] duration-500 cursor-pointer">
            <BsArrowLeft />
        </div>
        <div className="top-[60%] absolute z-10 button-next-slide h-[40px] w-[40px] text-white bg-black grid place-items-center group-hover:right-0  -right-[23rem] duration-500 cursor-pointer">
            <BsArrowRight  />
        </div>
    </Swiper>
    </div>
