        ...
        <div className='w-full h-full flex flex-col justify-between bg-zinc-200'>
            <div className="grid max-w-[1240px] my-20 m-auto">
                <div className='flex flex-col justify-center md:items-center w-full px-2 py-4 md:pl-16'>
                    <h2 className='text-3xl md:text-4xl tracking-wide font-bold text-center'> Our <text className='text-green-500'> Procedure  </text> </h2>
                    <p className='my-5 text-center px-10 md:px-40 font-extralight text-gray-800'>
                    ...
                    <img className=' hidden md:flex px-10 py-6' src={Procedure_img} alt="procedure content image" />
                    <img className='md:hidden px-10 py-6' src={Procedure_sm} alt="procedure content image" />
                </div>
            </div>
        </div>
    </div>
