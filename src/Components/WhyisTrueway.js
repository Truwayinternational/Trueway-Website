        ...
        <div className='w-full h-full flex flex-col justify-between'>
            <div className="grid max-w-[1240px] m-auto mt-20 ">
                <div className='flex flex-col justify-center md:items-center w-full px-2 py-4 md:pl-16'>
                    <h2 className='text-3xl md:text-4xl tracking-wide font-bold text-center font-HeadingFont px-3'> Why Is <b className='text-green-500'>Trueway Better</b> In Attestation Services? </h2>
