      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <dl className="grid  grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
            <div className="mx-auto flex max-w-xs flex-col gap-y-4 bg-white p-6 rounded-3xl shadow-2xl ">
              <img src={iso} alt="iso_icons" className='order-first w-[150px] h-[150px]'/>
              <dd className="text-md font-semibold tracking-tight  text-gray-500 md:text-1xl pt-10">ISO Certified Company </dd>
              {/* <dt className="text-2xl font-bold text-black"></dt> */}
            </div>
            <div className="mx-auto flex max-w-xs flex-col gap-y-4 bg-white p-6 rounded-3xl shadow-2xl ">
